    ...
    <div class="d-flex w-100">
        ...
        <div class="ms-5 flex-fill">
            ...
            <p class="text-danger fw-bold fs-3 m-0 p-0">10.000 đ</p>
                ...
                <p>
                    <span>Mô tả: </span> <br />Tivi Samsung QLED 4K 65 inch QA65Q70D là sự kết hợp hoàn hảo giữa thiết kế tinh tế và công nghệ tiên tiến, mang đến cho người dùng trải nghiệm giải trí đỉnh cao. Với màn hình 65 inch rộng lớn và độ phân giải 4K sắc nét, tivi này không chỉ đáp ứng nhu cầu xem phim, chơi game mà còn làm nổi bật không gian sống. Được tích hợp nhiều tiện ích thông minh như tìm kiếm bằng giọng nói, điều khiển qua ứng dụng di động,... Smart Tivi Samsung chắc chắn sẽ là sự lựa chọn tuyệt vời cho những ai yêu thích công nghệ hiện đại và tiện nghi.
