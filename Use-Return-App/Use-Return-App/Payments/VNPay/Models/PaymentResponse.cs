...
namespace Use_Return_App.Payments.VNPay.Models
{
    public class PaymentResponse
    {
        ...
        public static string TransactionStatusDescription(string code)
        {
            switch (code)
            {
        ...
        public static string VnPayResponseCodeDescription(string code)
        {
            switch (code)
            {
                ...
                case "79": return "Giao dịch không thành công do: Khách hàng nhập sai mật khẩu thanh toán quá số lần quy định. Xin quý khách vui lòng thực hiện lại giao dịch.";
